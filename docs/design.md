...
- **CTP 对拍（新增）**：从门面重放交易日 20260923 的 A、C 序列（`testdata/ctp/ctp-slices-20260923-7…-20.json` 里 C 两所、A 两所，种子交易日 20260922 开 1 手 → Settle → 20260923 昨 1），逐笔手续费等于柜台增量：A 的 ③ 0.3 / 8、C 的 ③ 0.2 / 2。⚠️ 实现之前先跑一次看它红：A 在本库报「介于 0 与平仓量之间」，C 报「额度分不分方向」
